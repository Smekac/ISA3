...
INSERT INTO novi_rekvizit (id, datum_kreiranja, image, naslov,opis, cena, admin_fan_id, registrovani_korisnik_id,ustanova_id) VALUES (1, '2018-01-29 00:55:56','http://www.coldsteel.com/media/catalog/product/cache/1/thumbnail/960x/17f82f742ffe127f42dca9de82fb58b1/8/8/88cs.jpg' , 'Mac', 'Mac sa logom Mocnih rendzera', 500, 1,NULL ,1);
INSERT INTO novi_rekvizit (id, datum_kreiranja, image, naslov,opis, cena, admin_fan_id, registrovani_korisnik_id,ustanova_id) VALUES (2, '2018-01-24 03:55:56','https://cdn.shopify.com/s/files/1/0221/1146/products/Hogwarts_black_gold_thumb.png?v=1511187218', 'Majica', 'Majica sa posterom Hari Potera', 150, 1,NULL ,1);

INSERT INTO korisceni_rekvizit (id, datum_kreiranja,image, naslov,opis, active_until,accepted_bid, status, registrovani_korisnik_id,admin_fan_id) VALUES (1, '2018-01-29 02:32:40', 'https://games.rs/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/k/a/kacket-maonsteel.jpg','Kacket', 'Licni kacket od Stivena Spilberga prilikom snimanja Supermen filma jednog od najvecih ostvarenja', '2018-01-29 02:32:45',NULL , 'PRIHVACEN', 5,1);
INSERT INTO korisceni_rekvizit (id, datum_kreiranja,image, naslov,opis, active_until,accepted_bid, status, registrovani_korisnik_id,admin_fan_id) VALUES (2, '2018-01-27 02:32:40', 'http://www.costumes.rs/wp-content/uploads/store/products/images/135701999083594.jpg','Sesir', 'Sesir glavnog junaka iz filma Pirati sa Kariba', '2019-02-15 02:32:45',NULL , 'PRIHVACEN', 5,1 );
INSERT INTO korisceni_rekvizit (id, datum_kreiranja, image, naslov,opis, active_until,accepted_bid, status, registrovani_korisnik_id,admin_fan_id) VALUES (3, '2018-01-27 01:32:40','http://www.mozzartsport.com/upload/OldMozzartImages/img/news/f/5/5/14766131048363.jpg' ,'Dres', 'Dres licno potpisan od Ramba Petkovica', '2019-02-15 02:32:45',NULL , 'PRIHVACEN', 6,1 );
INSERT INTO korisceni_rekvizit (id, datum_kreiranja, image, naslov,opis, active_until,accepted_bid, status, registrovani_korisnik_id,admin_fan_id) VALUES (4, '2018-01-27 01:32:40','https://goo.gl/TJ9gBe' ,'Dres', 'Premijera filma fudbalskog maga Maradonee ', '2019-02-15 02:32:45',NULL , 'NACEKANJU', 6,NULL );
